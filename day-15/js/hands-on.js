...
// The second call loses 'this' because the function is no longer called through the user object.
...
// call()
describe.call(u, "developer", "Bangalore");


// apply()
describe.apply(u, ["designer", "Mumbai"]);


// bind()
const boundDescribe = describe.bind(u, "developer");

boundDescribe("Chennai");
